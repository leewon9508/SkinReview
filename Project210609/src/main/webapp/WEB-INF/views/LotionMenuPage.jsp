...
<body>
	...
	<table>
		...
		<c:forEach var="board" items="${boardList}">
			<tr>
				...
				<td>${board.bhits}</td>
				<td><a
					href="boardview?bnumber=${board.bnumber}&page=${paging.page}">상세보기</a></td>
			</tr>
		</c:forEach>
	</table>
	...
	<c:choose>
		...
		<c:otherwise>
			<a href="lotionpage?page=${paging.page-1}">[이전]</a>&nbsp;
		</c:otherwise>
	</c:choose>
	...
	<c:choose>
		...
		<c:otherwise>
			<a href="lotionpage?page=${paging.page+1}">[다음]</a>
		</c:otherwise>
	</c:choose>
	...
	<form action="search" method="get" name="searchform">
		...
		</select> <input type="text" name="keyword" placeholder="검색어 입력" id="text">
